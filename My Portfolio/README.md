Here’s a **README.md guideline** you can use for your portfolio website project — it’s tailored to your background (web development, portfolio site for the developer‐club lead at MIT, etc.) but you can adjust as needed.
...
**Developer**: *[Your Name]*
**Role**: Lead & Founder, Developer’s Club @ **MIT Chhatrapati Sambhajinagar**
**Date**: *[Start date – Last updated]*
...
> Insert link to deployed site (e.g., `https://your‐domain.com`)
...
* **Design**: [Figma](https://www.figma.com) (link below)
* **Version Control**: Git + GitHub

## Design & Figma Link

You can view the design mockups and prototype in Figma:
[Figma Design – My Portfolio](https://www.figma.com/make/RLxuE8JNKLgbxcWME6HaOn/My-Portfolio?t=kWYaoDCoGyaLKCN5&fullscreen=1)
In the design:
